page 50250 "Purchasing Agent RC Custom"
{
    ...
    layout
    {
        area(rolecenter)
        {
            group(Control1900724808)
            {
                ...
                part(HeadlineRCProcurement; "Headline RC Project Manager")
                {
                ...
                part(ReleasedDocuments; "Approved Documents")
                {
                    ApplicationArea = Basic, Suite;
                }
    ...
    actions
    {
        ...
        area(embedding)
        {
            ...
            action("Purchase Requisitions")
            {
                ...
                ToolTip = 'View Purchase Requisitions';
            }
            action("Purchase Requisitions Archived")
            {
                ApplicationArea = Suite;
                Caption = 'Purchase Requisitions Archived';
                RunObject = Page "Archived Purchase Requisitions";
                ToolTip = 'View Archived Purchase Requisitions';
            }
