...
page 50269 "Sales Manager Activities"
{
    Caption = 'Sales Stocks Activities';
    PageType = CardPart;
    RefreshOnActivate = true;
    SourceTable = "Sales And Stocks Cue";
    ShowFilter = false;
    ...
    layout
    {
        area(Content)
        {
            ...
            cuegroup(CreditMemos)
            {
                ...
                field("Credit Memos - Open"; Rec."Credit Memos - Open")
                {
                    ApplicationArea = Basic, Suite;
                    DrillDownPageId = "Sales Credit Memos";
                    ToolTip = 'Specifies the number of the Open Credit Memos';
                }
                field("Credit Memos Pending Approval"; Rec."Credit Memos Pending Approval")
                {
                    ApplicationArea = Basic, Suite;
                    DrillDownPageId = "Sales Credit Memos";
                    ToolTip = 'Specifies the number of the Open Credit Memos Pending Approval.';
                }
                field("Credit Memos - Released"; Rec."Credit Memos - Released")
                {
                    ApplicationArea = Basic, Suite;
                    DrillDownPageId = "Sales Credit Memos";
                    ToolTip = 'Specifies the number of the Released Credit Memos';
                }
