table 50251 "Sales Cue Loading"
{
    Caption = 'Sales Cue Loading';
    ...
    fields
    {
        ...
        field(50000; "Picking Slips - Open"; Integer)
        {
            CalcFormula = Count("Pick Instruction Header" where("Approval Status" = const(Open)));
        ...
        field(50001; "Purchase Requisitions - Open"; Integer)
        {
        ...
        field(50002; "Purchase Req Pending Approval"; Integer)
        {
            CalcFormula = Count("Requisition Header" where("Document Type" = const(Purchase), Status = const(Open)));
        ...
        field(50003; "Purchase Requisitions Released"; Integer)
        {
        ...
        field(50004; "Stock Requisitions - Open"; Integer)
        {
        ...
        field(50005; "Stock Requisitions - Pending"; Integer)
        {
        ...
        field(50006; "Stock Requisitions - Released"; Integer)
        {
    ...
    local procedure OnAfterSetRespCenterFilter(var SalesCue: Record "Sales Cue Loading"; RespCenterCode: Code[10])
    begin
    end;
