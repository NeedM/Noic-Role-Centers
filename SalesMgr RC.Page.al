page 50263 "Sales Manager RC"
{
    Caption = 'Sales Manager Role Center';
    PageType = RoleCenter;
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            // part(SalesAndStocksActivities; "Sales and Stocks Activities")
            // {
            //     AccessByPermission = TableData "Sales Shipment Header" = R;
            //     ApplicationArea = Basic, Suite;
            // }
            part(SalesMgrActivities; "Sales Manager Activities")
            {
    ...
    actions
    {
        ...
        area(sections)
        {
            group(Action76)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Sales Proformer Invoices';
                    Promoted = true;
                    PromotedCategory = Process;
